...
lettuce tomato slices and cucumber`, images:"images/111.jpg"
}, {
 name: "Waffle",
...
Step 3
Ladle the batter into a preheated waffle iron. Cook the waffles until golden and crisp. Serve immediately.`,images:"images/222.jpg"
}, {
 name: "Biryani",
...
and garnish with 1 tbsp fried onions and coriander leaves. Serve hot chicken biryani.`,images:"images/333.jpg"
...
Step 5
Serve rolled spring rolls with the fish sauce and hoisin sauce mixtures.`,images:"images/444.jpg"
}, {
  name: "Sambosa",
...
Serve warm with chutney.`,images:"images/555.jpg"
},
{
  name: "Sausage",
...
Step 5
Bake for 25-30 minutes or until golden and cooked through.`,images:"images/6666.jpg"
}, {
  name: "Chicken Grill",
...
grill until no longer pink in the center and the juices run clear, about 5 minut`,images:"images/7777.jpg"
}, {
  name: "Mento",
...
$("#waffle").on('click', () => {
  window.localStorage.setItem("recipe1", JSON.stringify(recipes[1]))
  //const chicken = JSON.parse(window.localStorage.getItem("recipe2"))
})
$("#Biryani").on('click', () => {
  window.localStorage.setItem("recipe1", JSON.stringify(recipes[2]))
  //const chicken = JSON.parse(window.localStorage.getItem("recipe3"))
})
$("#SpringRolls").on('click', () => {
  window.localStorage.setItem("recipe1", JSON.stringify(recipes[3]))
  //const chicken = JSON.parse(window.localStorage.getItem("recipe4"))
})
$("#Sambosa").on('click', () => {
  window.localStorage.setItem("recipe1", JSON.stringify(recipes[4]))
  //const chicken = JSON.parse(window.localStorage.getItem("recipe5"))
})
$("#Sausage").on('click', () => {
  window.localStorage.setItem("recipe1", JSON.stringify(recipes[5]))
  //const chicken = JSON.parse(window.localStorage.getItem("recipe6"))
})
$("#chicken").on('click', () => {
  window.localStorage.setItem("recipe1", JSON.stringify(recipes[6]))
  //const chicken = JSON.parse(window.localStorage.getItem("recipe7"))
})
$("#Mento").on('click', () => {
  window.localStorage.setItem("recipe1", JSON.stringify(recipes[7]))
